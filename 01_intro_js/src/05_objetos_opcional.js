/**
 *Objetos, atributo opciona 
 *también aplica en caso de que la API tenga un relay de carga, evitar nullPoint
 */
...
console.log(factura.empresa?.nombre);
if (factura.empresa?.nombre){
    console.log('perfecto!!!');
}else{
    console.log('no viene la empresa');
}
console.log(facturaRelaciones.cliente?.nombre);